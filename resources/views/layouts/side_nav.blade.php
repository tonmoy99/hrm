<aside class="left-sidebar">
	...
	<nav class="sidebar-nav">
		...
		<li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Job Manage</span></a>
		    <ul aria-expanded="false" class="collapse">
			<li><a href="{{route('designation_manage')}}">Job designations</a></li>
			<li><a href="{{route('job_list_manage')}}">Job List</a></li>
			<li><a href="{{route('department_manage')}}">Department</a></li>
			
		    </ul>
		</li>
		
		<li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Candidate Manage</span></a>
		    <ul aria-expanded="false" class="collapse">
			<li><a href="{{route('candidate_form_manage')}}">Candidate List</a></li>
		    </ul>
		</li>
		
		<li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Employee Manage</span></a>
		    <ul aria-expanded="false" class="collapse">
			<li><a href="{{route('employee_manage')}}">Employee List</a></li>
			<li><a href="{{route('employee_attendance_list')}}">Employee Attendance List</a></li>
			<li><a href="{{route('emp_absent_list')}}">Employee Absent List</a></li>
			<li><a href="{{route('emp_report')}}">Employee Report</a></li>
		    </ul>
		</li>
